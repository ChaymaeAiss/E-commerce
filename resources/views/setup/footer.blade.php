            ...
            <div class="container">
                        ...
                        <section class="footer-item">
                            ...
                            <div class="footer-phone-info">
                                ...
                                <p class="r-info">
                                    ...
                                    <span>(+212) 65 618 758 476</span>
                                </p>
                            </div>
                            <div class="newsletter-block layout-01">
                                <h4 class="title">Let us know you!</h4>
                                ...
                                <ul class="contact-lines">
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc">25 St. IFMOTICA, OFPPT, FES </b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-phone"></i>
                                            <b class="desc">Phone: (+212) 65 618 758 476</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-letter"></i>
                                            <b class="desc">Email:  chaymaeAiss@gmail.com</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-12">
                        <div class="copy-right-text"><p><a href="templateshub.net">Chaymae AL-aissaoui</a></p></div>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-xs-12">
                        <div class="payment-methods">
                            <ul>
                                ...
                                <li><a href="https://www.paypal.com/fr/home" class="payment-link"><img src="assets/images/card3.jpg" width="51" height="36" alt=""></a></li>
